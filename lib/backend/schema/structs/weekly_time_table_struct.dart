...
class WeeklyTimeTableStruct extends FFFirebaseStruct {
  ...
  static WeeklyTimeTableStruct fromMap(Map<String, dynamic> data) =>
      WeeklyTimeTableStruct(
        ...
        mon: DailyTimeTableFormatStruct.maybeFromMap(data['mon']),
        tue: DailyTimeTableFormatStruct.maybeFromMap(data['tue']),
        wed: DailyTimeTableFormatStruct.maybeFromMap(data['wed']),
        thu: DailyTimeTableFormatStruct.maybeFromMap(data['thu']),
        fri: DailyTimeTableFormatStruct.maybeFromMap(data['fri']),
        sat: DailyTimeTableFormatStruct.maybeFromMap(data['sat']),
        sun: DailyTimeTableFormatStruct.maybeFromMap(data['sun']),
