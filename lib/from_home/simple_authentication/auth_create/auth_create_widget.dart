                              ...
                              child: FutureBuilder<List<NotificationRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final dropDownNotificationRecord =
                                      dropDownNotificationRecordList.isNotEmpty
                                          ? dropDownNotificationRecordList.first
                                          : null;
                                  ...
                                  return FlutterFlowDropDown<String>(
                                    controller:
                                        _model.dropDownValueController2 ??=
                                            FormFieldController<String>(null),
                                    options: dropDownNotificationRecord!
                                        .spotdatas
                                        .map((e) => e.spot)
                                        .toList(),
                                    onChanged: (val) => safeSetState(
                        ...
                        onPressed: () async {
                          ...
                          await UsersRecord.collection.doc(user.uid).update({
                            ...createUsersRecordData(
                              ...
                              forWhat: _model.dropDownValue1,
                              school: _model.emailAddressTextController2.text,
                              createdTime: getCurrentTimestamp,
                              isAdmin: false,
                              seatNo: 0,
                              totalPoint: 0,
                              spot: _model.dropDownValue2,
                              rankOpen: true,
