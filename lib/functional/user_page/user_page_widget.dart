...
import '/functional/userdeep/terms_of_services/terms_of_services_widget.dart';
            ...
            children: [
              ...
              FutureBuilder<ApiCallResponse>(
                ...
                builder: (context, snapshot) {
                  ...
                  final richTextGetFromSheetResponse = snapshot.data!;
                  ...
                  return RichText(
                    ...
                    text: TextSpan(
                      children: [
                        ...
                        TextSpan(
                          text: getJsonField(
                            richTextGetFromSheetResponse.jsonBody,
                            r'''$[0][3]''',
                          ).toString(),
                            ...
                            children: [
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    context.pushNamed('setBestColorPage');
                                  },
                                  child: Container(
                                    width: 44.0,
                                    height: 44.0,
                                            ...
                                            child: GestureDetector(
                                              onTap: () =>
                                                  FocusScope.of(dialogContext)
                                                      .unfocus(),
                                              child: const SecondPinConfirmWidget(),
                                            ),
                                          );
                                        },
                                      );
                                        ...
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'wgfti7v9' /* 개인정보처리방침(Privacy Policy) */,
                                              ),
                                              textAlign: TextAlign.start,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                          ...
                                          return Dialog(
                                            ...
                                            child: GestureDetector(
                                              onTap: () =>
                                                  FocusScope.of(dialogContext)
                                                      .unfocus(),
                                              child: const TermsOfServicesWidget(),
                                            ),
                                          );
                                        },
                                      );
                                        ...
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'd3r0jmd3' /* 이용약관(Terms of Service) */,
                                              ),
                                              textAlign: TextAlign.start,
                                              style:
                                                  FlutterFlowTheme.of(context)
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    FFAppState().deletePlannerDateSelected();
                                    FFAppState().plannerDateSelected = null;

                                    FFAppState().loadedDataID = null;
                                    FFAppState().timeIsGoing = false;
                                    FFAppState().deleteWeeklyTimeTableChoice();
                                    FFAppState().weeklyTimeTableChoice = [];
