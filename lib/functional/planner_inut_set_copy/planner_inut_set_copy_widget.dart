                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (_) => EasyDebounce.debounce(
                            ...
                            () async {
                              if (functions.isSubjectInList(
                                  _model.textController1.text,
                                  FFAppState()
                                      .fixSubjectColorAppState
                                      .toList())) {
                                _model.colorToSet = FFAppState()
                                    .fixSubjectColorAppState[
                                        functions.getSubjectIndex(
                                            _model.textController1.text,
                                            FFAppState()
                                                .fixSubjectColorAppState
                                                .toList())!]
                          ...
                          (e) => e
                            ..updateInputListState(
                              (e) => e.add(PlannerInputStruct(
                                subjectNamePlanner: _model.textController1.text,
                                pickedColor: _model.colorToSet,
