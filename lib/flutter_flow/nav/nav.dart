      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => HomePageWidget(
            right: params.getParam(
              'right',
              ParamType.String,
            ),
            left: params.getParam(
              'left',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: 'backup',
          path: '/backup',
          builder: (context, params) => const BackupWidget(),
        ),
        FFRoute(
          name: 'userPage',
          path: '/userPage',
        ...
        FFRoute(
          name: 'analyticsPage',
          path: '/analyticsPage',
          builder: (context, params) => const AnalyticsPageWidget(),
        ),
        FFRoute(
          name: 'adminSeatConfigure',
          path: '/adminSeatConfigure',
          builder: (context, params) => const AdminSeatConfigureWidget(),
        ),
        FFRoute(
          name: 'adminplannerPage',
          path: '/adminplannerPage',
        ...
        FFRoute(
          name: 'adminSeatChange',
          path: '/adminSeatChange',
          builder: (context, params) => const AdminSeatChangeWidget(),
        ),
        FFRoute(
          name: 'adminPointConfigurePage',
          path: '/adminPointConfigurePage',
          builder: (context, params) => const AdminPointConfigurePageWidget(),
        ),
        FFRoute(
          name: 'studentAnalytics',
          path: '/studentAnalytics',
          builder: (context, params) => const StudentAnalyticsWidget(),
        ),
        FFRoute(
          name: 'setBestColorPage',
          path: '/setBestColorPage',
          builder: (context, params) => const SetBestColorPageWidget(),
        ),
        FFRoute(
          name: 'pageeee',
          path: '/pageeee',
        ...
        FFRoute(
          ...
          path: '/timerPageCopy',
          requireAuth: true,
          builder: (context, params) => TimerPageCopyWidget(
            subNameParameter: params.getParam(
              'subNameParameter',
              ParamType.String,
            ),
