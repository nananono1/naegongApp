                              ...
                              Builder(
                                builder: (context) {
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemBuilder: (context, plannergoIndex) {
                                      final plannergoItem =
                                      ...
                                      return InkWell(
                                        ...
                                        onTap: () async {
                                          FFAppState().pageStateSchemaVariable =
                                              PageStateSchemaStruct(
                                            inputListState:
                                                plannergoItem.inputListState,
                                            submittedDatePlanner: plannergoItem
                                                .submittedDatePlanner,
                                            goodThingsPlanner:
                                                plannergoItem.goodThingsPlanner,
                                            imporovementState:
                                                plannergoItem.imporovementState,
                                            archivePercentState: plannergoItem
                                                .archivePercentState,
                                            basicInfoState:
                                                plannergoItem.basicInfoState,
                                            dailyStartPara:
                                                plannergoItem.dailyStartPara,
                                            adminCheckedPara:
                                                plannergoItem.adminCheckedPara,
                                          );
                                          FFAppState().loadedDataID = _model
                                              .bb?[plannergoIndex].reference;
                                          FFAppState().update(() {});
                                          FFAppState().seatNoSelected =
                                              plannergoItem
                                                  .basicInfoState.userSeatNo;
                                          FFAppState().adminUserName =
                                              plannergoItem
                                                  .basicInfoState.userName;
                                          FFAppState().maxNumberOfPlan =
                                              plannergoIndex;
                                          FFAppState().update(() {});
                                        },
