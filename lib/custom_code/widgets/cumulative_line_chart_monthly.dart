...
class CumulativeLineChartMonthly extends StatefulWidget {
  const CumulativeLineChartMonthly({
    super.key,
    this.width,
    this.height,
  ...
  @override
  State<CumulativeLineChartMonthly> createState() =>
      _CumulativeLineChartMonthlyState();
}

class _CumulativeLineChartMonthlyState
    extends State<CumulativeLineChartMonthly> {
  @override
